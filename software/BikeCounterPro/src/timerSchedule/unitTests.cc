...
TEST_F(TimerScheduleTest, BasicIntervalTests)
{
    ...
    ASSERT_EQ(ts1.getNextIntervalTime(t1), t1sol);
    ...
    ASSERT_EQ(ts1.getNextIntervalTime(t2), t2sol);
    ...
    ASSERT_EQ(ts1.getNextIntervalTime(t3), t3sol);
}
...
TEST_F(TimerScheduleTest, LastCallOfTheDayTests)
{
    ...
    ASSERT_EQ(ts1.getNextIntervalTime(t1sol), t2sol);
}
